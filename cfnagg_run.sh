...
if [ "$TOPOLOGY_TYPE" == "DCN" ]; then
    ...
    echo "TopologyType is ISP. Generating ISP network..."
...
#NS_LOG=ndn.Consumer:ndn.ConsumerINA:ndn.Aggregator:ndn-cxx.nfd.Forwarder ./waf --run cfnagg
...
#NS_LOG=ndn-cxx.nfd.BestRouteStrategy ./waf --run cfnagg
